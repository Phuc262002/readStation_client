                ...
                <div class="bg-white dark:bg-dark h-full">
                    <div class="p-3.5">
                        <a class="main-logo w-full" href="index.html">
                            <img src="assets/admin/images/logo-dark.svg" class="mx-auto dark-logo h-8 logo dark:hidden" alt="logo">
                            <img src="assets/admin/images/logo-light.svg" class="mx-auto light-logo h-8 logo hidden dark:block" alt="logo">
                            <img src="assets/admin/images/logo-icon.svg" class="logo-icon h-8 mx-auto hidden" alt="">
                        </a>
                    </div>
                    <div class="flex items-center gap-2.5 py-2.5 pe-2.5">
                        ...
                        <button type="button" class="shrink-0 btn-toggle hover:text-primary duration-300" >
                            <svg class="w-3.5" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path opacity="0.2" d="M5.46133 6.00002L11.1623 12L12.4613 10.633L8.05922 6.00002L12.4613 1.36702L11.1623 0L5.46133 6.00002Z" fill="currentColor"></path>
                                <path d="M0 6.00002L5.70101 12L7 10.633L2.59782 6.00002L7 1.36702L5.70101 0L0 6.00002Z" fill="currentColor"></path>
                            </svg>
                        </button>
                    </div>
                    <div class="h-[calc(100vh-93px)] overflow-y-auto overflow-x-hidden space-y-16 px-4 pt-2 pb-4">
                        <ul class="relative flex flex-col gap-1 text-sm" x-data="{ activeMenu: 'dashboard' }">
                            <li class="menu nav-item">
                                <a href="javaScript:;" class="nav-link group items-center justify-between active" >
                                    ...
                                    <div class="w-4 h-4 flex items-center justify-center dropdown-icon !rotate-180">
                                ...
                                <ul x-show="activeMenu === 'dashboard'" x-collapse="" class="sub-menu flex flex-col gap-1">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'social'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                <a href="javaScript:;" class="nav-link group items-center justify-between">
                                    <div class="flex items-center">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M8.42229 20.618C10.1779 21.5393 11.0557 22 12 22V12L2.63802 7.07264C2.62423 7.09479 2.6107 7.11716 2.5974 7.13974C2 8.15425 2 9.41667 2 11.9415V12.0585C2 14.5833 2 15.8458 2.5974 16.8603C3.19479 17.8748 4.27063 18.4393 6.42229 19.5685L8.42229 20.618Z" fill="currentColor"></path>
                                            <path opacity="0.5" d="M17.5774 4.43152L15.5774 3.38197C13.8218 2.46066 12.944 2 11.9997 2C11.0554 2 10.1776 2.46066 8.42197 3.38197L6.42197 4.43152C4.31821 5.53552 3.24291 6.09982 2.6377 7.07264L11.9997 12L21.3617 7.07264C20.7564 6.09982 19.6811 5.53552 17.5774 4.43152Z" fill="currentColor"></path>
                                ...
                                <ul x-show="activeMenu === 'components'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'elements'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                <a  class="nav-link group" href="chart.html">
                                    <div class="flex items-center">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="menu nav-item">
                                <a  class="nav-link group" href="font-icons.html">
                                    <div class="flex items-center">
                                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <path fill-rule="evenodd" clip-rule="evenodd" d="M8.25 9C8.25 8.58579 8.58579 8.25 9 8.25H15C15.4142 8.25 15.75 8.58579 15.75 9C15.75 9.41421 15.4142 9.75 15 9.75H12.75V15C12.75 15.4142 12.4142 15.75 12 15.75C11.5858 15.75 11.25 15.4142 11.25 15V9.75H9C8.58579 9.75 8.25 9.41421 8.25 9Z" fill="currentColor"></path>
                                            ...
                                            <path d="M4 22C5.10457 22 6 21.1046 6 20C6 18.8954 5.10457 18 4 18C2.89543 18 2 18.8954 2 20C2 21.1046 2.89543 22 4 22Z" fill="currentColor"></path>
                                            <path d="M22 4C22 5.10457 21.1046 6 20 6C18.8954 6 18 5.10457 18 4C18 2.89543 18.8954 2 20 2C21.1046 2 22 2.89543 22 4Z" fill="currentColor"></path>
                                            <path d="M20 22C21.1046 22 22 21.1046 22 20C22 18.8954 21.1046 18 20 18C18.8954 18 18 18.8954 18 20C18 21.1046 18.8954 22 20 22Z" fill="currentColor"></path>
                                            <g opacity="0.3">
                                                <path d="M4.75 5.85462C4.51839 5.94837 4.26523 6 4 6C3.73477 6 3.48161 5.94837 3.25 5.85462V18.1454C3.48161 18.0516 3.73477 18 4 18C4.26523 18 4.51839 18.0516 4.75 18.1454V5.85462Z" fill="currentColor"></path>
                                                <path d="M5.85462 4.75H18.1454C18.0516 4.51839 18 4.26523 18 4C18 3.73477 18.0516 3.48161 18.1454 3.25H5.85462C5.94837 3.48161 6 3.73477 6 4C6 4.26523 5.94837 4.51839 5.85462 4.75Z" fill="currentColor"></path>
                                                <path d="M19.25 5.85462C19.4816 5.94837 19.7348 6 20 6C20.2652 6 20.5184 5.94837 20.75 5.85462V18.1454C20.5184 18.0516 20.2652 18 20 18C19.7348 18 19.4816 18.0516 19.25 18.1454V5.85462Z" fill="currentColor"></path>
                                                <path d="M18.1454 19.25H5.85462C5.94837 19.4816 6 19.7348 6 20C6 20.2652 5.94837 20.5184 5.85462 20.75H18.1454C18.0516 20.5184 18 20.2652 18 20C18 19.7348 18.0516 19.4816 18.1454 19.25Z" fill="currentColor"></path>
                                            </g>
                                        </svg>
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'tabels'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'forms'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'invoice'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'userprofile'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'pages'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                            ...
                            <li class="menu nav-item">
                                ...
                                <ul x-show="activeMenu === 'authentication'" x-collapse="" class="sub-menu flex flex-col gap-1" style="display: none; height: 0px; overflow: hidden;" hidden="">
                        ...
                        <div class="bg-primary p-[18px] relative sidebar-upgrade rounded-md">
                            <div class="relative z-10">
                                <div class="flex items-center gap-2">
                                    <img src="assets/admin/images/upgrade.png" alt="" class="rounded-full">
                            ...
                            <div class="z-0">
                                <img src="assets/admin/images/upgrade-illustrator.png" class="absolute right-0 bottom-0" alt="">
                            </div>
                        </div>
                    </div>
                </div>
