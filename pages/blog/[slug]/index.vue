    ...
    <div class="md:px-20 md:container md:mx-auto px-8 md:py-10 py-5">
        <div class="flex gap-[30px]">
            <div class="w-3/4">
                ...
                >
                    ...
                    >
                        ...
                        >
                            <div
                                class="h-4 w-4 bg-[#6C40FF] rounded-full"
                            ></div>
                            <div
                                class="text-[#6C40FF] w-fit text-sm font-normal"
                            >
                        ...
                        <div class="pt-4">
                            ...
                            >
                                ...
                                <div
                                    class="h-1 w-1 bg-white rounded-full"
                                ></div>
                                <p>10 min read</p>
                            </div>
                        </div>
            ...
            <div class="w-1/4">
                ...
                <div
                    class="p-5 border bg-[#0A1C8F]/[100%] w-full h-70 rounded-[10px]"
                >
