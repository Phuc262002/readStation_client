...
<template>
  <div class="bg-orange-100">
    <div class="px-5 py-7">
      <div
        class="flex justify-between gap-20 w-full h-auto mx-auto container md:px-20 px-8"
      >
        <!-- left -->
              ...
              <div class="w-1/3 pt-16">
                ...
                >
                  <img
                    class="rounded-lg"
                    :src="
                      getFeauturedBooks?.getbookFeatured?.bookBanner?.poster
                    "
                    alt=""
                  />
                </NuxtLink>
              ...
              <div class="w-1/2 flex flex-col gap-5">
                ...
                <div class="flex justify-between items-center">
                  ...
                  <a-button
                    ...
                    "
                    type="primary"
                    class="w-1/2 rounded-lg text-white"
        ...
        <div class="w-1/2 grid grid-cols-3 gap-4">
          <div
            v-for="(data, index) in getFeauturedBooks?.getbookFeatured?.books"
          >
