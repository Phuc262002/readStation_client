  ...
  >
    ...
    <div class="flex items-center gap-5">
      <div x-data="{ fullScreen: false }">
        <button
          class="text-lightgray hover:text-primary block"
      ...
      <div class="notification h-6" x-data="dropdown">
        ...
        >
          <div class="flex items-center gap-2">
            <h4 class="font-semibold text-dark dark:text-white">
              Notifications
            </h4>
          ...
          <div class="text-end">
            <a
              href="javascript:;"
              class="text-gray font-semibold text-sm hover:text-primary duration-300"
              >View More</a
            >
          </div>
        </div>
      </div>
      <div class="profile z-10" x-data="dropdown">
        <button type="button" class="flex items-center gap-2.5">
          ...
          <div class="text-start">
            ...
            <span class="hidden xl:block text-xs text-lightgray"
              >CEO & Founder</span
            >
          </div>
        </button>
