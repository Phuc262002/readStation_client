    ...
    <a-modal v-model:open="props.openModal" title="Cập nhật tình trạng sách" style="width: 500px;" :footer="null"
        ...
        <form @submit.prevent="onSubmit">
            ...
            <div class="flex flex-col gap-2 mt-4">
                ...
                <a-select v-model:value="valueReturnEachBook.actual_return_condition" show-search placeholder="Trạng thái" size="large"
            ...
            <div class="flex flex-col gap-2 mt-4">
                ...
                <a-input size="large" v-model:value="valueReturnEachBook.fine_amount"></a-input>
            </div>
...
// const valueReturnEachBook = ref({
//     condition: queryStatus.value.value,
//     actual_return_condition: "",
//     fine_amount: ""
// });
const onSubmit = async () => {
    try {
        await orderStore.retrunEachBook({id:loan_order_detail_id.value, valueRetunEachBook: valueReturnEachBook.value  })
    } catch (error) {
