    ...
    <div class="grid grid-cols-1">
      <div>
        ...
        >
          <li>
            <a
              class="text-dark dark:text-white duration-300"
              href="ecommerce.html"
              >Overview</a
            >
          </li>
          <li>
            <a
              class="hover:text-dark duration-300 dark:hover:text-white"
      ...
      >
        <div class="flex items-center gap-2.5 flex-wrap">
          ...
          <div class="flex items-end gap-3">
            ...
            <div>
              <span
                class="flex items-center text-gray bg-gray/10 rounded-full py-1 px-2 gap-1 text-xs font-semibold"
                >3.47%
                <svg
                  width="10"
                  height="10"
      ...
      >
        <div class="mb-[30px] flex items-center flex-wrap">
          ...
          <div>
            <select
              id="selectDays"
              class="form-select h-8 rounded-full border-none font-semibold text-xs"
            >
            ...
            <tbody>
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-2.5">
                    <img
                      src="assets/admin/images/product/1.png"
                ...
                <td>
                  <span
                    class="bg-success text-white font-bold text-xs py-2 px-3 rounded-full"
                    >Paid</span
                  >
                </td>
                <td>$215</td>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-2.5">
                    <img
                      src="assets/admin/images/product/2.png"
                      class="w-[50px] rounded-full"
                      alt=""
                    />
                    <div class="flex-1 max-w-[200px] truncate">
                ...
                <td>
                  <span
                    class="bg-orange text-white font-bold text-xs py-2 px-3 rounded-full"
                    >Unpaid</span
                  >
                </td>
                <td>$542</td>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-2.5">
                    <img
                      src="assets/admin/images/product/3.png"
                      class="w-[50px] rounded-full"
                      alt=""
                    />
                    <div class="flex-1 max-w-[200px] truncate">
                      <p class="line-clamp-1 truncate">
                        Galaxy Hi-Tech Exclusive
                      </p>
                ...
                <td>
                  <span
                    class="bg-primary text-white font-bold text-xs py-2 px-3 rounded-full"
                    >Done</span
                  >
                </td>
                <td>$980</td>
              ...
              <tr>
                ...
                <td>
                  <div class="flex items-center gap-2.5">
                    <img
                      src="assets/admin/images/product/4.png"
                      class="w-[50px] rounded-full"
                      alt=""
                    />
                    <div class="flex-1 max-w-[200px] truncate">
