  ...
  <div>
    <div>
      ...
      <div class="flex mt-3">
        <div class="w-1/2 grid grid-cols-12 border-r border-rtgray-50">
          <div class="col-span-4">
            <img
              :src="order?.data?.book_details?.poster"
              alt=""
          ...
          <div class="col-span-8 text-sm space-y-3">
            ...
            >
              ...
              <div
                class="col-span-2"
                v-for="(items, index) in order?.data?.return_histories"
                :key="index"
              >
      ...
      >
        ...
        <a-textarea
          v-model:value="review.review_text"
      ...
      <div class="flex justify-end pt-4 gap-2">
        ...
        >
          <a-button
            class="h-10"
            @click="showModalGive(order?.data)"
            v-if="
              order?.data?.status === 'active' ||
              $dayjs(new Date()).format('YYYY-MM-DD') ===
                $dayjs(order?.data?.current_due_date).format('YYYY-MM-DD')
          ...
          <a-button
            ...
            "
            class="h-10 bg-orange-500 !text-white border-none"
            @click="showModalExtend(order?.data)"
          >
            Gia hạn lần 1
          </a-button>
        </div>
