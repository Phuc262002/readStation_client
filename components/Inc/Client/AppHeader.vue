            ...
            <div class="h-50 pt-5">
                ...
                >
                    ...
                    <div class="md:flex justify-center items-center hidden">
                        <div
                            class="flex justify-center items-center gap-2 mr-4"
                        >
                            ...
                            <NuxtLink to="/login">
                                <button
                                    class="w-32 hover:bg-gray-100 hover:rounded-xl h-10"
                                >
                                    <div
                                        class="flex justify-center items-center gap-3 text-base"
                                    >
                                        <SmileOutlined />
                                        <h2>Tài khoản</h2>
                                    </div>
                        ...
                        <div
                            class="border-solid border border-gray-300 h-8"
                        ></div>
                        <div class="ml-3">
                            <NuxtLink to="/cart">
                                <button
