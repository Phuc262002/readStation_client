        ...
        <div class="flex flex-col gap-2 pt-4 md:flex-row md:items-center print:hidden">
            <div class="grow">
                <h5 class="text-xl text-[#1e293b] font-semibold">Đánh giá sách “{{
                    bookDetail.getOneBookDetailAdmin?.book?.title }} -
                ...
                <div class="md:col-span-1 space-y-2 border-r border-gray-200">
                    ...
                    <div class="grid grid-cols-3">
                        ...
                        <span class="text-base">{{
                            bookDetail.getOneBookDetailAdmin?.book?.author?.author }}</span>
                    </div>
                    <div class="grid grid-cols-3">
                    ...
                    <div class="grid grid-cols-3">
                        ...
                        <span class="text-base">{{
                            bookDetail.getOneBookDetailAdmin?.book?.shelve?.name ?
                                bookDetail.getOneBookDetailAdmin?.book?.shelve?.name : '' }}</span>
                    </div>
                ...
                <div class="md:col-span-2 space-y-3">
                    <div class="grid grid-cols-4">
                        ...
                        <span class="text-base col-span-3">
                            {{
                                bookDetail.getOneBookDetailAdmin?.book?.description_summary }}</span>
                    </div>
                    <div class="grid grid-cols-4">
        ...
        <div class="bg-[white] rounded-lg h-auto w-full flex flex-col gap-3 p-5">
            <div class="flex gap-2">
                <a-dropdown :trigger="['click']">
                    <template #overlay>
                        <a-menu class="">
                            <a-menu-item @click="fitlerRating({ value: '', label: 'Tất cả sao' })">Tất cả
                                sao</a-menu-item>
                            <a-menu-item>
                ...
                <a-dropdown :trigger="['click']">
                    <template #overlay>
                        <a-menu class="">
                            <a-menu-item @click="statusValue({ value: '', label: 'Trạng thái' })">Tất cả trạng
                                thái</a-menu-item>
