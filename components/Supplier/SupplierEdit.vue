          ...
          <div class="grid gap-4 my-3">
            <div class="space-y-4">
              <div class="flex flex-col gap-2">
                ...
                <a-input
                  v-model:value="valueSupplier.name"
                  size="large"
                  type="text"
              ...
              <div class="flex flex-col gap-2">
                ...
                <a-input
                  v-model:value="valueSupplier.phone"
                  size="large"
                  type="text"
                  class="border p-2 rounded-md"
              ...
              <div class="flex flex-col gap-2">
                ...
                <a-input
                  v-model:value="valueSupplier.email"
                  size="large"
                  type="text"
                  class="border p-2 rounded-md"
                  placeholder="Email"
              ...
              <div class="flex flex-col gap-2">
                ...
                <a-input
                  size="large"
                  v-model:value="valueSupplier.address"
                  type="text"
                  class="border p-2 rounded-md"
              ...
              <div class="flex flex-col gap-2">
                ...
                <a-select
                  v-model:value="valueSupplier.status"
                  show-search
