        ...
        <div
          ...
          <NuxtLink to="/">
            <div class="flex items-center gap-1">
              <img class="h-10" src="../../../assets/images/Read Station.svg" alt="" />
            </div>
          </NuxtLink>
          ...
          <div class="md:block hidden">
            <ul class="flex items-center py-[3px]">
              <!-- <li>
                <NuxtLink to="/">
                  <a-button class="text-black text-base hover:-translate-y-1 transition-transform" type="link">Trang
                    chủ</a-button>
                </NuxtLink>
              </li> -->
              <li>
                <NuxtLink to="/shop"><a-button class="text-black text-base hover:-translate-y-1 transition-transform"
                    type="link">Cửa hàng</a-button>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink to="/post"><a-button class="text-black text-base hover:-translate-y-1 transition-transform"
                    type="link">Blog</a-button></NuxtLink>
              </li>
              <li>
                <NuxtLink to="/about-us"><a-button
                    class="text-black text-base hover:-translate-y-1 transition-transform" type="link">Giới
                    thiệu</a-button>
                </NuxtLink>
              </li>
              <li>
                <NuxtLink to="/contact"><a-button class="text-black text-base hover:-translate-y-1 transition-transform"
                    type="link">Liên hệ</a-button>
                </NuxtLink>
              </li>
              <!-- <li>
          ...
          <div class="relative w-1/4 md:block hidden">
            <div class="flex">
              ...
              <div class="absolute right-24 mt-2 border-solid border border-gray-300 h-6"></div>
              <button type="button"
                class="absolute right-0 h-full px-4 text-gray-400 rounded-r-md hover:bg-orange-300  transition-colors focus:outline-none">
                Tìm kiếm
              </button>
            </div>
