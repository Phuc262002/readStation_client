...
export const useHomeStore = defineStore("home-store", {
  ...
  actions: {
    ...
    async getBookFeatured() {
      this.isLoading = true;
      const data: any = await useCustomFetch("/api/v1/public/home/get-feautured-book");
    ...
    async getRecomendedBooks() {
      this.isLoading = true;
      const data: any = await useCustomFetch("/api/v1/public/home/get-recommend-book");
    ...
    async getLastestBook() {
      this.isLoading = true;
      const data: any = await useCustomFetch("/api/v1/public/home/get-book-lastest");
    ...
    async getStatistic() {
      this.isLoading = true;
      const data: any = await useCustomFetch("/api/v1/public/home/get-statistic");
